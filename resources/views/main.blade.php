        ...
        <div class="col-md-4 bg-secondary border border-dark border-2">
            <div class="row">
                <div class="col-4 d-flex p-2 align-items-center justify-content-center ">
                    <img src="https://vertexcooperation.com/images/home/{{$siteDate['userData']['username']}}.jpg" alt="image"
        ...
        <div class="col-md-4 bg-secondary border border-dark border-2">
            <div class="row">
                ...
                <div class="col-12">
                    <ul>
                        <li class="text-white">
                            @if(isset($siteDate['upcomingEvent']['day_name']))
                                {{ $siteDate['upcomingEvent']['day_name'] }}
                            @else
                                No data found
                            @endif
                        </li>
